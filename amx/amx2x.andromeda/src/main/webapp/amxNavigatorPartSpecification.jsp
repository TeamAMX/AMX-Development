...
<head>
  <meta charset="UTF-8" />
  <title>Andromeda Part Specifications</title>
...
<body>
  ...
  <div class="header-left">
    ...
    <div class="header-content">
      <div class="header-title">Part Specification List</div>
      <div class="header-subtitle">
        View and manage part specification information
      </div>
    </div>
  </div>
...
<div class="table-container">
  <div class="table-scroll">
    <table id="psTable" class="display" style="width:100%">
      <thead>
        <tr></tr>
      </thead>
      <tbody></tbody>
  ...
  $(document).ready(function () {      
      $.ajax({
        url: BASIC_URL+'/api/datafetchservice/latestpartspecifications',
        method: 'GET',
        dataType: 'json',
        ...
        error: function (xhr, status, error) {
          console.error('Error fetching Part specifications:', error);
      ...
      $('#showMyPs').click(function () {
          ...
          $.ajax({
              ...
              error: function (xhr, status, error) {
                  console.error(error);
                  $('#errorMessage').text('Failed to fetch current user Part specifications.');
              }
