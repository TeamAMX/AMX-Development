...
<div class="topbar">
  <div class="topbar-left">
    ...
    <div>
      <div class="topbar-name" id="fileName">File Details</div>
      <div class="topbar-type" id="fileType">File Properies</div>
    </div>
  </div>
...
<div class="page-container">
  <!-- Sidebar -->
  <div class="sidebar">
  <a href="#" id="filePropertiesTab" class="nav-link active"><i class="fa-solid fa-sliders"></i> File Properties</a>
...
$(document).ready(function () {
  ...
  $.ajax({
    url: BASIC_URL+'/api/datafetchservice/getfiledetails',
    method: 'GET',
  ...
  function populateTopBar(data) {
	    $('#fileName').text(data.name || 'File Details');
	    $('#fileType').text(data.type || 'File');
  ...
  function populateTable(part) {
	    ...
	    const fieldIcons = {
	        filename: 'fa-solid fa-tag',
	        fileformat: 'fa-solid fa-cube',
	        filesize: 'fa-solid fa-weight-hanging',
	        createddate: 'fa-regular fa-calendar',
	        description: 'fa-solid fa-align-left',
	    };

	    card.append(buildRow('filename', 'File Name', part.filename || part.name || '', fieldIcons));

	    card.append(buildRow('fileformat', 'File Format', getFileFormat(part.filename || part.name || ''), fieldIcons));

	    card.append(buildRow('filesize', 'File Size', formatSizeMB(part.filesize), fieldIcons));

	    card.append(buildRow('createddate', 'Created Date', part.createddate || '-', fieldIcons));
  ...
  $('#filePropertiesTab').on('click', function (e) {
	  e.preventDefault();
