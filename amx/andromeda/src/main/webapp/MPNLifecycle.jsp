...
<style>
  ...
  #inWorkLabel { background-color: #5bc0de; }
  #frozenLabel { background-color: #6c757d; }
  #releasedLabel { background-color: #28a745; }
  #obseloteLabel { background-color: #dc3545; }

  .state-label:hover { background-color: #ddd; }
  ...
  #stateMessages .message { margin: 10px 0; }
...
<div class="container">
  ...
  <div class="sidebar">
    ...
    <a class="nav-link active" href="MPNLifecycle.jsp?name=<%= request.getParameter("name") %>">LifeCycle</a>
  </div>
